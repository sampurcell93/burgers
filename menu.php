		<div class="wrap" id='menu'>
			...
			<div class="fl w45 p10">
				<h2>Specials - Burgers</h2>
					<dl>
						...
						<dt>The Cool Kid</dt>
						<dd>Pepperjack cheese, lettuce, tomato, cool ranch Doritos, and barbeque sauce</dd>
						<dt>Baby Got Jack</dt>
						<dd>Cajun burger with jalapeno pineapple relish, bacon, cheddar, onions</dd>
						<dt>Swing and a Swiss</dt>
						<dd>Lettuce, tomato, Pineland Farms bacon swiss spread, and more bacon</dd>
						<dt>La Arriba</dt>
						...
						<dt>Italiano</dt>
						<dd>Fresh mozzarella, roasted red peppers, arugula, pesto mayo</dd>
						<dt>Crafty Burger</dt>
						<dd>Topped with homemade mac and cheese and bacon</dd>
						<dt>The Aloha!</dt>
						<dd>Pineapple ring, teriyaki sauce, bacon, red pepper flakes</dd>
					</dl>
				<h2>Chicken Sandwiches</h2>
					<dl>
						<dt>Plain Jane</dt>
						<dd>Lettuce, tomato, pickle, house sauce</dd>
						<dt>Winner Winner</dt>
			...
			<div class="fr w45 p10" id='sides-menu'>
				...
				<dl>
					<dt>French Fries</dt>
					<dt>Parmesan and Garlic Fries</dt>
					<dd>Our fries taken to a whole 'nother level</dd>
					<dt>Onion Rings</dt>
					<dd>Served with sweet and smoky chipotle aioli</dd>
					<dt>Potato Salad</dt>
					<dt>Black Bean Salad</dt>
					<dt>Roasted Corn Salad</dt>
				</dl>
			</div>
			<div class="clear"></div>
		</div>